...
template <> constexpr inline auto SimulationController::qt_create_metaobjectdata<qt_meta_tag_ZN20SimulationControllerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'createPlanet'
        QtMocHelpers::MethodData<void(QObject *, qreal, qreal)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 3 }, { QMetaType::QReal, 4 }, { QMetaType::QReal, 5 },
        }}),
    };
...
void SimulationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->createPlanet((*reinterpret_cast< std::add_pointer_t<QObject*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qreal>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<qreal>>(_a[3]))); break;
        default: ;
        }
    }
}
